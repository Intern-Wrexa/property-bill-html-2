...
@app.get("/fetch-property-details/old-bill/response/{zone_no}/{ward_no}/{property_id}/{sub_no}")
...
@app.get("/fetch-property-details/new-bill/response/{zone_no}/{ward_no}/{bill_no}")
